...
export class ItemsController {
  ...
  //   return await this.itemsService.createItem(request, req.cookies?.Authentication, user);
  // }
  ...
  // @Put(':id')
  // @UseGuards(JwtAuthGuard)
  // async modifyItem(@CurrentUser() user: User, @Param('id') id: string, @Body() request: CreateItemRequest) {
